...
namespace Writings.Api.Tests.Integration.WritingsController
{
    ...
    public class CreateWritingsControllerTests(WritingsApiFactory appFactory) : IAsyncLifetime
    {
        ...
        [Fact]
        public async Task Create_ShouldReturnCreatedStatus_WhenWritingIsCreatedAndAuthorisationIsValid()
        {
            //Arrange
        ...
        [Fact]
        public async Task Create_ShouldReturnForbiddenStatus_WhenAuthorisationIsInvalid()
        {
            //Arrange
            var writing = _writingGenerator.Generate();
